...
The gradient descent algorithm, introduced by Augustin-Louis Cauchy [@Cauchy:1847], has become one of the most widely used algorithms, with applications ranging from economics (e.g., portfolio optimization [@Suykens:2014] and game theory [@Daskalakis:2018]) to engineering [@Martins:2021], operations research [@Taha:2017], and machine learning [@Goodfellow:2016; @Hastie:2009].
